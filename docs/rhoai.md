...
2) Go to the `Data Science Projects` section and access your application's project named `ai-software-templates-dev`.

![image](./images/data-science-projects.png)

3) Access the `workbench` named `codegen-070303-notebook`.
...
5) In the terminal, run `cd codegen-070303` to navigate to your sample app's directory.
